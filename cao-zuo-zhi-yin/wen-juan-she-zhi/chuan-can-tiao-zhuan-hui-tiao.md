...
![API配置](<../../.gitbook/assets/image (683).png>)

## 提交问卷跳转到指定页面

功能开启后，在设置弹窗中填写跳转的链接（链接需为包含http://或http://前缀的地址），设置完成后当答题者提交问卷后浏览器将跳转到您设置的链接上。

![功能流程](<../../.gitbook/assets/image (333).png>)

![设置跳转地址](<../../.gitbook/assets/image (658).png>)

## 登录态回调接口

提供登录态回调的功能，开发者可自行配置回调地址和密钥，问卷系统将登录态等参数回调给开发者，开发者获取参数后可用于奖励发放。

![操作流程](<../../.gitbook/assets/image (448).png>)

![配置登录态回调](<../../.gitbook/assets/image (653).png>)
...
![多个回调地址配置示例](<../../.gitbook/assets/image (654).png>)
...
![API调用](<../../.gitbook/assets/image (710).png>)
