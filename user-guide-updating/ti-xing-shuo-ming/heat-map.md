...
It can be set whether the respondent is required to provide a reason.
...
3.Click "Export by zone" to select the area on the heatmap from which you want to export data for local analysis. (For example, if you only want to view the quiz details of players who selected the face, the corresponding area data will be automatically exported after confirming the selection.)
