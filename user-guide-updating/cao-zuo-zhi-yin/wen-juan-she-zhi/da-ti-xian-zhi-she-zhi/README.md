...
| Parameter Passing (Strict Validation) | The uid value when passing parameters (customized by the game), for details please refer to[参数传递接口（严格校验模式）](../../../../api-wen-dang/cai-ji-wan-jia-openid/fei-msdk-deng-lu-tai-chuan-di-jie-kou.md)                                                                                                                                    | 30291658356950347                                                                             |
| Parameter Passing (No Validation)     | The openid value when passing parameters (customized by the game), for more details please refer to[参数传递接口（不校验模式）](../../../../api-wen-dang/cai-ji-wan-jia-openid/can-shu-chuan-di-jie-kou-bu-xiao-yan-mo-shi.md)                                                                                                                       | 30291658356950347                                                                             |
