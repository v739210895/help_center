...
Supports adding multiple filter conditions for naming and reuse. The system will query the latest collected data for the current survey in real time based on the filter logic associated with the label and recalculate the statistical results.
