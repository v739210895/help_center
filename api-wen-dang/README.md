...
| 场景                                                         | 使用接口                                                                                                                                                                                                                                                                                                                                                             |
| ---------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 采集内嵌投放的用户openid                                            | <p>以下登录态对接五选一，建议首选MSDK</p><p><a href="msdkv3-deng-lu-tai-cai-ji.md">MSDK v3登录态采集</a><br><a href="msdkv5-deng-lu-tai-cai-ji.md">MSDK v5登录态采集</a><br><a href="intl-deng-lu-tai-cai-ji.md">INTL登录态采集</a><br><a href="fei-msdk-deng-lu-tai-chuan-di-jie-kou.md">参数传递接口（严格校验模式）</a><br><a href="can-shu-chuan-di-jie-kou-bu-xiao-yan-mo-shi.md">参数传递接口（不校验模式）</a></p> |
